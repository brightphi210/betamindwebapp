...
const PartyIcon = () => (
    <svg width="100" height="100" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M14 50L26 22L42 38L14 50Z" fill="#a6ff00" stroke="#a6ff00" strokeWidth="2" strokeLinejoin="round" />
        ...
        <path d="M32 30 L38 28 M35 36 L42 35 M38 42 L44" stroke="#a6ff00" strokeWidth="2" strokeLinecap="round" />
        <circle cx="46" cy="12" r="1.6" fill="#ff8fb0" />
    </svg>
);

// ---------- Success screen (matches MentorOnboardingSuccess) ----------

const MentorProductSuccess: React.FC<{ type: ProductType; title: string }> = ({ type, title }) => {
        ...
        >
            ...
            <div className="relative z-10 flex min-h-screen w-full justify-center px-4 py-16 pt-24">
                <div className="w-full max-w-md text-center">
                    <div className="mx-auto mb-6 text-5xl flex items-center justify-center rounded-2xl">
                        <PartyIcon />
                    </div>
                    ...
                    <p className="mt-3 text-sm text-white/50 sm:text-base">
                        Your {type.toLowerCase()} <span className="font-semibold text-white">{title || "product"}</span> is now live for mentees to purchase.
                    </p>

                    <div className="mt-8 rounded-2xl p-6 text-left" style={{ background: cardBg, border: cardBorder }}>
                        <p className="mb-5 text-center text-sm text-white/50">
                            Mentees can now find and buy this {type.toLowerCase()} from your profile. You can manage it anytime from your products list.
                        </p>
                        ...
                        <div className="justify-center m-auto gap-2 flex">
                            ...
                            <Button variant="white" onClick={() => navigate("../products")}>
                                <span className="flex items-center justify-center gap-2">View Products</span>
                            </Button>
                        </div>
                    </div>
                </div>
...
export default MentorProductSuccess;