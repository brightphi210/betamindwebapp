...
const SessionBookedSuccess: React.FC = () => {
    return (
        <div
            className="flex min-h-screen w-full justify-center px-4 py-10 pt-20 sm:pt-32"
            style={{
                background:
